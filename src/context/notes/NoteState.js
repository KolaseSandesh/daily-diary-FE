...
const NoteState = (props) => {
  ...
  const about = {
    ...
    desc: "Welcome to Daily Dairy, This versatile platform is useful for note making for students, teachers, workers and for everyone. Students and Teachers can use this for storing their notes and other important details in the text format  ",
  };
  const aboutChange = {
