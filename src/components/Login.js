...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response?.success) {
        toast.success("Welcome to Daily Diary", {
          position: "top-center",
          autoClose: 1000,
          hideProgressBar: false,
          closeOnClick: true,
        ...
        <div className="col-12 col-sm 12 col-md-6 col-lg-6">
          <div className="">
            <div className="display-4 fw-bold">
              Welcome back to Daily Diary
            </div>
            <div className="my-2 fs-5">
              Unlock the note making wonders that await you! Log in to your
              Daily Diary account and embark on a journey where your
